...
First, let's get our Microbit setup and ensure that we can program it. Start
with your computer, the short USB cable, and your microbit. 

![mbsetup1](https://images.jointheleague.org/microbit/mb_setup_1.png){.c600}
...
<img class="inline" src="https://images.jointheleague.org/microbit/import_button.png"> 
...
![mb_editor](https://images.jointheleague.org/microbit/mb_editor.png){.c600}

```{admonition} Chrome Browser Recommended
:class: warning
For the next step, downloading, you should be running the Chrome browser,
although  Firefox or Edge might also work. But Chrome is best supported. 
If you have a Chromebook, you are running Chrome
```
...
![big_heart](https://images.jointheleague.org/microbit/big_heart.png){.c100}
